package com.zyd.blog.controller.third_party_service.juhe.calendar.api;
...
public class CalendarApi extends JHCommon {
    ...
    public static String getCalendarDayInfo(Date date) {
        ...
        //您申请的appKey
        params.put("date", com.example.demo.core.util.DateUtil.formatShortDate(date, "YYYY-M-d"));
    ...
    public static String getCalendarMonthInfo(Date date) {
        ...
        params.put("key", APPKEY);
        //您申请的appKey
        params.put("year-month", com.example.demo.core.util.DateUtil.formatShortDate(date, "YYYY-M"));
    ...
    public static String getCalendarYearInfo(Date date) {
        String url = "http://v.juhe.cn/calendar/year";
        //请求接口地址
        Map params = new HashMap();
        //请求参数
        params.put("key", APPKEY);
        //您申请的appKey
        params.put("year", com.example.demo.core.util.DateUtil.formatDate(date, "YYYY"));
        //指定年份,格式为YYYY,如:2015
