...
<@header title="${config.siteName!} | 忘尘莫急，听雨无忧"
            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">本站正式启用新域名:<a href="http://520sea.top:1949/" target="_blank"><strong>http://520sea.top:1949/</strong></a></a>
                    </li>
                    <li class="scrolltext-title">
