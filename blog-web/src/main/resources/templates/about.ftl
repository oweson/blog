        ...
        <div class="row about-body">
            ...
            <div class="col-sm-12 blog-main">
                <div class="blog-body expansion">
                    <h5 class="custom-title"><i class="fa fa-user-secret fa-fw"></i><strong>站长简介</strong><small></small></h5>
                    <div class="info">
                        <p>
                            码农一枚
                        </p>
                    </div>
                    <h5 class="custom-title"><i class="fa fa-coffee fa-fw"></i><strong>关于本站</strong><small></small></h5>
                    <div class="info">
                        本站为非商业化站点，无盈利性质。
                    </div>
